> module SequentialDecisionProblems.Generic.ExtraNaiveAssumptions
...
then it is easy to show that |optExt| as defined in |CoreNaiveTheory|
does in fact compute optimal extensions of arbitrary policy
sequences. This and Bellman's principle of optimality are the key
results needed to prove that |CoreTheory.backwardsInduction| does indeed
return optimal policy sequences, see
|FullTheory.backwardsInductionLemma|.
